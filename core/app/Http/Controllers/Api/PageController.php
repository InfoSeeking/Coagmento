        ...
        if ($is_query)
        {
            ...
            if($searchEngine=='google')
            {
                if($exists_serp == 0){
                    ...
                    if(strpos($url,'google.si') !== false){
                        $cmd = "curl -e http://coagmento.org " . "'https://www.googleapis.com/customsearch/v1?key=AIzaSyDvs3gTrHMbWasvRyRnourCiaysnICGaLM&cx=015815412952122646184:uowapxwpxfy&googlehost=google.si&q=".$query_stringwithplus."'";
                        $data=shell_exec($cmd);
                    }
                    else if(strpos($url,'google.ca') !== false){
                        $cmd = "curl -e http://coagmento.org " . "'https://www.googleapis.com/customsearch/v1?key=AIzaSyDvs3gTrHMbWasvRyRnourCiaysnICGaLM&cx=015815412952122646184:uowapxwpxfy&googlehost=google.ca&q=".$query_stringwithplus."'";
                        $data=shell_exec($cmd);
                    }
                    else if(strpos($url,'google.co.uk') !== false){
                        $cmd = "curl -e http://coagmento.org " . "'https://www.googleapis.com/customsearch/v1?key=AIzaSyDvs3gTrHMbWasvRyRnourCiaysnICGaLM&cx=015815412952122646184:uowapxwpxfy&googlehost=google.co.uk&q=".$query_stringwithplus."'";
                        $data=shell_exec($cmd);
                    }else{
                        $cmd = "curl -e http://coagmento.org " . "'https://www.googleapis.com/customsearch/v1?key=AIzaSyDvs3gTrHMbWasvRyRnourCiaysnICGaLM&cx=015815412952122646184:uowapxwpxfy&q=".$query_stringwithplus."'";
                        $data=shell_exec($cmd);
                    }
                    if($save_files){
