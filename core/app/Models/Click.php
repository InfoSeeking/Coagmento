...
class Click extends Model
{
    ...
    protected $visible = ['created_at', 'updated_at', 'user_id', 'project_id', 'id', 'type', 'client_x', 'client_y', 'page_x', 'page_y', 'screen_x', 'screen_y', 'scroll_x', 'scroll_y', 'created_at_local','created_at_local_ms'];
}
