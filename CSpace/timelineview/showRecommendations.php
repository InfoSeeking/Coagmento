...
<!-- <table class="body" width=100%>
	...
	<tr>
		<td colspan=2>
			...
			Here you can see the recommendations of webpages that your collaborators made using Coagmento. You can also recommend webpages to your collaborators or even non-users by clicking on 'Recommend' button on Coagmento toolbar.
			</div>
		</td>
	</tr>
</table> -->
