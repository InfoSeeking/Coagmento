  <input type="hidden" id="pfc_minmax" onclick="pfc.swap_minimize_maximize()" src="<?php echo $c->getFileUrlFromTheme('images/'.($start_minimized?'maximize':'minimize').'.gif'); ?>" alt=""/>
...
<?php } ?>
      ...
      <div class="pfc_btn">
        <img src="<?php echo $c->getFileUrlFromTheme('images/logout.gif'); ?>"
             alt="Connect/Disconnect" title="Connect/Disconnect"
             id="pfc_loginlogout"
             onclick="pfc.connect_disconnect()" />
      </div>

      <div class="pfc_btn">
        <input type="hidden" src="<?php echo $c->getFileUrlFromTheme('images/color-on.gif'); ?>"
             alt="" title=""
             id="pfc_nickmarker"
      ...
      <div class="pfc_btn">
        <img src="<?php echo $c->getFileUrlFromTheme('images/clock-on.gif'); ?>"
             alt="Show/Hide Time" title="Show/Hide Time"
             id="pfc_clock"
      ...
      <div class="pfc_btn">
        <img src="<?php echo $c->getFileUrlFromTheme('images/sound-on.gif'); ?>"
             alt="Turn On/Off Sound Alert" title="Turn On/Off Sound Alert"
             id="pfc_sound"
      ...
      <div class="pfc_btn">
        ...
        alt="Show/Hide Smileys" title="Show/Hide Smileys"
      ...
      <div class="pfc_btn">
        <img src="<?php echo $c->getFileUrlFromTheme('images/online-on.gif'); ?>"
             alt="Who is Online" title="Who is Online"
      ...
      <div id="pfc_bt_strong_btn" class="pfc_btn">
        <input type="hidden" src="<?php echo $c->getFileUrlFromTheme('images/bt_strong.gif'); ?>"
             id="pfc_bt_strong"
      ...
      <div id="pfc_bt_italics_btn" class="pfc_btn">
        <input type="hidden" src="<?php echo $c->getFileUrlFromTheme('images/bt_em.gif'); ?>"
             id="pfc_bt_italics"
      ...
      <div id="pfc_bt_underline_btn" class="pfc_btn">
        <input type="hidden" src="<?php echo $c->getFileUrlFromTheme('images/bt_ins.gif'); ?>"
             id="pfc_bt_underline"
      ...
      <div id="pfc_bt_delete_btn" class="pfc_btn">
        <input type="hidden" src="<?php echo $c->getFileUrlFromTheme('images/bt_del.gif'); ?>"
             id="pfc_bt_delete"
...
<!--
      <div id="pfc_bt_mail_btn" class="pfc_btn">
        <input type="hidden" src="<?php echo $c->getFileUrlFromTheme('images/bt_mail.gif'); ?>"
             id="pfc_bt_mail"
...
-->
      <div id="pfc_bt_color_btn" class="pfc_btn">
        <input type="hidden" src="<?php echo $c->getFileUrlFromTheme('images/bt_color.gif'); ?>"
