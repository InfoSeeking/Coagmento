...
*/
  ...
  {
    console.log("User is issuing command: '" + cmd + "' " + recipientid);
...
*/
  ...
  nickmarker_swap: function()
  {
    ...
    setCookie('pfc_nickmarker', this.nickmarker);
     ...
     new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_nickmarkerSwap', value: this.nickmarker },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  clock_swap: function()
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_clockSwap', value: this.clock },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  sound_swap: function()
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_soundAlert', value: this.issoundenable},
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  connect_disconnect: function()
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_connectDisconnect', value: this.isconnected },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  swap_minimize_maximize: function()
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_swapMinimizeMaximize', value: this.minmax_status },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  insert_text_callback: function(text, pfcp)
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_insertTextCallback', value: open+close },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  switch_text_color: function(color)
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_switchTextColor', value: this.current_text_color },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  showHideSmileys: function()
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_showSmileysBox', value: this.showsmileys },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
  ...
  showHideWhosOnline: function()
  {
    ...
    new Ajax.Request('chat/insertAction.php', {
      method: 'post',
      parameters: {action: 'chat_showHideWhosOnline', value: this.showwhosonline },
      onSuccess: function(transport) {
        eval( transport.responseText );
      }
    });
