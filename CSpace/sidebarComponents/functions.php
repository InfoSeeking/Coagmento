...
function getRatingRepresentation($finalRating,$itemID,$itemType,$layer,$region,$webPage)
{
	...
	for ( $i = 0; $i < (int)$finalRating; $i++)
		$result = $result . "<img src=\"images/fullstar.gif\" height=\"10\" width=\"10\" alt=\"Rate\">";
	$rest = 5-$finalRating;
	$decimal = $finalRating - (int)$finalRating;
	if (($decimal>=0.1) and ($decimal<=0.9))
		$result = $result . "<img src=\"images/halfstar.gif\" height=\"10\" width=\"10\" alt=\"Rate\">";

	for ( $i = 0; $i < (int)$rest; $i++)
		$result = $result . "<img src=\"images/emptystar.gif\" height=\"10\" width=\"10\" alt=\"Rate\" >";
	$result = $result . "</div>";
