<?php
	if ((isset($_SESSION['CSpace_userID']))) {
		...
		echo "<tr>";
		echo "<td align=\"center\"><img src=\"images/asc.gif\" height=\"10\" width=\"10\" alt=\"Asc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','userName asc','pagesBox','bookmarks.php')\"><span style=\"font-size:10px; color:#FFFFFF\">-</span><img src=\"images/desc.gif\" height=\"10\" width=\"10\" alt=\"Desc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','userName desc','pagesBox','bookmarks.php')\"></td>";
		echo "<td align=\"left\"><img src=\"images/asc.gif\" height=\"10\" width=\"10\" alt=\"Asc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','title asc','pagesBox','bookmarks.php')\"><span style=\"font-size:10px; color:#FFFFFF\">-</span><img src=\"images/desc.gif\" height=\"10\" width=\"10\" alt=\"Desc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','title desc','pagesBox','bookmarks.php')\"></td>";
		echo "<td align=\"center\"><img src=\"images/asc.gif\" height=\"10\" width=\"10\" alt=\"Asc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','finalRating asc','pagesBox','bookmarks.php')\"><span style=\"font-size:10px; color:#FFFFFF\">-</span><img src=\"images/desc.gif\" height=\"10\" width=\"10\" alt=\"Desc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','finalRating desc','pagesBox','bookmarks.php')\"></td>";
		echo "<td align=\"center\"><img src=\"images/asc.gif\" height=\"10\" width=\"10\" alt=\"Asc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','pageID asc','pagesBox','bookmarks.php')\"><span style=\"font-size:10px; color:#FFFFFF\">-</span><img src=\"images/desc.gif\" height=\"10\" width=\"10\" alt=\"Desc\" class=\"cursorType\" onclick=\"javascript:changeOrder('Pages','pageID desc','pagesBox','bookmarks.php')\"></td>";
		//echo "<td></td>";
		echo "</tr>";
		...
		while ($line = mysql_fetch_array($results, MYSQL_ASSOC)) {
			...
			//echo "<td align=\"right\"><img src=\"images/view.gif\" height=\"18\" width=\"18\" alt=\"View\" class=\"cursorType\" onclick=\"javascript:showPage('floatBookmarkLayer',null,'$pageID')\">";
			//echo "<span style=\"font-size:10px; color:$bgColor\">-</span><div class=\"sourceText\"><img src=\"images/copy.gif\" height=\"18\" width=\"18\" alt=\"Copy\" class=\"cursorType\" onclick=\"javascript:copyToClipboard('pageValue$pageID')\"><div></td>";
